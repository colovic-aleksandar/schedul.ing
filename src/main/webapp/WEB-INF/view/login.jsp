...
<body>
    ...
    <form:form action="login" method="post">
        ...
        <div><label> User Name : <input type="text" name="username" /></div>
        <div><label> Password : <input type="password" name="password" /></div>
        <div><label> Remember Me : <input type="checkbox" name="remember-me" /></div>
